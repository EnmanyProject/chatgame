    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: systemPrompt || '당신은 한국어 AI 캐릭터 프롬프트 생성 전문가입니다. 제공된 캐릭터 정보를 바탕으로 한국어로 상세하고 매력적인 캐릭터 프롬프트를 작성해주세요. 모든 응답은 반드시 한국어로 해야 하며, 한자 문자(漢字)는 절대 사용하지 마세요.'
          },
          {
            role: 'user',
            content: userPrompt
