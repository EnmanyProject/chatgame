...
작성 스타일:
- 매우 상세하고 구체적으로 (최소 3000자 이상 필수, 5000자 권장)
- 제공된 모든 데이터를 빠짐없이 포함 (55개 필드 전체)
- 각 수치와 점수를 구체적으로 언급 (예: "감정지능 8점", "자신감 6점")
- 배열 데이터의 모든 항목을 개별적으로 설명 (예: 취미가 ["게임", "독서"]면 둘 다 별도로 언급)
- MBTI 특성이 모든 행동과 사고에 자연스럽게 반영
- 외모 세부사항을 매우 구체적으로 묘사 (헤어, 눈, 체형, 스타일 등)
- 심리적 특성과 과거 경험을 풍부하게 설명
- 대화 스타일과 말 습관을 자세히 기술
- 한국어로 자연스럽고 매력적이면서도 정보량이 매우 풍부하게 작성

🎯 절대 목표:
1. 최소 3000자 이상의 상세한 설명
2. 제공된 캐릭터 데이터의 모든 정보를 100% 포함
3. 읽는 사람이 캐릭터를 완벽히 이해할 수 있는 수준의 디테일

⚠️ 중요: 짧게 요약하지 말고, 매우 상세하고 풍부하게 작성하세요. 길이가 길수록 좋습니다.`;
