...
- **이름을 반복하지 말고** "이 친구는", "얘는", "그런데" 같은 자연스러운 표현 사용
...
- **한국어로만 작성, 한자 문자 절대 사용 금지**
- **친근하고 재미있게** 1500-2000자 정도로 소개
- "~야", "~지", "~거든" 같은 친근한 말투 사용

예시 시작: "내가 소개해줄 친구는 정말 특별한 사람이야. 얘는..."로 시작하는 식으로 작성해주세요.`;
    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: systemPrompt || '당신은 친구를 자연스럽게 소개하는 전문가입니다. 마치 가까운 친구가 다른 친구를 소개하듯이, 편안하고 친근한 말투로 매력적인 AI 소개글을 작성해주세요. 딱딱한 설명보다는 자연스러운 대화체로, 한국어로만 작성하며 한자 문자는 절대 사용하지 마세요.'
          },
          {
            role: 'user',
            content: userPrompt
